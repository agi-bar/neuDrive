  ...
  return (
    ...
    >
      ...
      <ol className="setup-steps">
        ...
        <li>请求网址填写 <code>{callbackUrl}</code>，把其中的 <code>&lt;your-slug&gt;</code> 换成 Agent Hub 用户 slug。</li>
        ...
        <li>推荐同时开启加密推送，并把 <code>Encrypt Key</code> 配到 <code>FEISHU_ENCRYPT_KEY</code>；Agent Hub 已支持飞书要求的签名校验和事件解密。</li>
        <li>保存配置后，飞书会先发起 <code>challenge</code> 验证；验证通过后，后续消息事件就会被 Agent Hub 接收。</li>
      </ol>
