"""OAuth / authentication helper for third-party apps integrating with Agent Hub."""
...
class AgentHubAuth:
    ...
    def github_callback(self, code: str) -> dict[str, Any]:
        ...
        the Agent Hub backend which handles the token exchange.
    ...
    def __enter__(self) -> "AgentHubAuth":
        return self
